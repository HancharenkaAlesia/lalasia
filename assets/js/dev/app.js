...
function initSliders() {
  ...
  if (document.querySelector(".art-slider")) {
    new Swiper(".art-slider", {
      ...
      speed: 800,
      navigation: {
        prevEl: ".art-slider__prev",
        nextEl: ".art-slider__next"
      },
      //touchRatio: 0,
      //simulateTouch: false,
      //loop: true,
  ...
  if (document.querySelector(".banner-slider__slider")) {
    new Swiper(".banner-slider__slider", {
      // <- Вказуємо склас потрібного слайдера
      // Підключаємо модулі слайдера
      // для конкретного випадку
      modules: [Navigation, Parallax, Autoplay, Pagination, EffectFade],
      autoplay: {
        delay: 5e3
      },
      effect: "fade",
